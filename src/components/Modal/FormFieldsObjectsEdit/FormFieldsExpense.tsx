    ...
    <>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input id="classification" {...field} placeholder="Classificação (opcional)" />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input id="description" {...field} placeholder="Descrição (opcional)" />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input id="justification" {...field} placeholder="Justificativa da despesa" />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormField
        ...
        render={({ field }) => {
          return (
            <FormItem>
              <FormLabel htmlFor="expense_actor_id">ID do Responsável</FormLabel>
              <FormControl>
                <Input
                  id="expense_actor_id"
                  type="number"
                  ...
                  placeholder="ID do responsável pela despesa"
                />
              </FormControl>
              <FormMessage />
            </FormItem>
        ...
        render={({ field }) => (
          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
            ...
            <div className="space-y-1 leading-none">
              <FormLabel htmlFor="requires_reimbursement">
                Requer Reembolso
              </FormLabel>
            </div>
          </FormItem>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
            ...
            <div className="space-y-1 leading-none">
              <FormLabel htmlFor="applies_all_products">
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex flex-row items-start space-x-3 space-y-0">
            ...
            <div className="space-y-1 leading-none">
              <FormLabel htmlFor="applies_all_machines">
