    ...
    <>
      ...
      <FormField
        ...
        render={({ field }) => {
          return (
            <FormItem>
              <FormLabelWithHelp htmlFor="machine_number" label="Número da máquina" helpText={help.machineNumber} />
              <FormControl>
                <Input
                  id="machine_number"
                  type="number"
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            <FormLabelWithHelp htmlFor="location_status" label="Status de Localização" helpText={help.locationStatus} />
            <Select onValueChange={field.onChange} value={field.value}>
              <FormControl>
                <SelectTrigger>
